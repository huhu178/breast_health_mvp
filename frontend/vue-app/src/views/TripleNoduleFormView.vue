...
async function submitForm() {
  ...
  try {
    ...
    if (hasFiles) {
      ...
      formDataObj.append('nodule_types', 'triple')
  ...
  <div class="record-form-view">
    ...
    <header class="page-header-compact">
      <div class="header-left">
        ...
        <h2 class="page-title">三结节档案（乳腺·甲状腺·肺）</h2>
      </div>
    ...
    <div class="form-layout">
      <form @submit.prevent="submitForm">
        ...
        <!-- （二）三结节影像学特征 - 并列布局 -->
        <div class="triple-nodule-container">
          <!-- 乳腺影像学特征 -->
          <section class="form-section imaging-section-breast">
            <div class="section-header">
              <div class="section-icon"></div>
          ...
          <section class="form-section imaging-section-lung">
            <div class="section-header">
              <div class="section-icon"></div>
              <h3 class="section-title">（四）肺部影像学特征</h3>
            </div>
...
.triple-nodule-container .form-section {
  margin-bottom: 0;
}
