...
async function submitForm() {
  ...
  try {
    ...
    if (hasFiles) {
      ...
      // 统一结节类型命名：后端/模板使用 lung_thyroid
      formDataObj.append('nodule_types', 'lung_thyroid')
  ...
  <div class="record-form-view">
    ...
    <header class="page-header-compact">
      <div class="header-left">
        ...
        <h2 class="page-title">甲状腺+肺双结节档案</h2>
      </div>
      ...
      <form @submit.prevent="submitForm">
        ...
        <div class="dual-nodule-container">
          ...
          <section class="form-section imaging-section-thyroid">
            <div class="section-header">
              <div class="section-icon"></div>
              <h3 class="section-title">（二）甲状腺影像学特征</h3>
            </div>
